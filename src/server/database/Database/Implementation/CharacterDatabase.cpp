...
void CharacterDatabaseConnection::DoPrepareStatements()
{
   ...
   // PrepareStatement(CHAR_INS_HARDCORE_DEATH, "INSERT INTO hardcore_deaths(char_guid, char_name, level, playtime, killer_name, death_time) VALUES ('%u', '%s', '%u', '%u', '%s', '%u')", CONNECTION_SYNCH);
    ...
    PrepareStatement(CHAR_INS_ARENA_REPLAYS, "INSERT INTO character_arena_replays (arenaTypeId, typeId, contentSize, contents, mapId, winnerTeamName, winnerTeamRating, winnerTeamMMR, loserTeamName, loserTeamRating, loserTeamMMR, winnerPlayerGuids, loserPlayerGuids) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", CONNECTION_ASYNC);
}

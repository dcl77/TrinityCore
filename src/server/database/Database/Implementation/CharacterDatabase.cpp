...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(CHAR_INS_PVPSTATS_BATTLEGROUND, "INSERT INTO pvpstats_battlegrounds (id, winner_faction, bracket_id, type, rated, date) VALUES (?, ?, ?, ?, ?, NOW())", CONNECTION_ASYNC);
    ...
    PrepareStatement(CHAR_INS_PVPSTATS_ARENA_TEAM, "INSERT INTO pvpstats_arena_teams (battleground_id, arena_team_id, winner, rating_change, mmr) VALUES (?, ?, ?, ?, ?)", CONNECTION_ASYNC);
